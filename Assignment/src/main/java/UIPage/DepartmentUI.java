...
public class DepartmentUI extends javax.swing.JFrame {
    ...
    private boolean checkVal(){
        if(DeptId.getText().equals("")){
            JOptionPane.showMessageDialog(this, "Department Id cannot be blank");
            return false;
        }
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(DeptId, javax.swing.GroupLayout.DEFAULT_SIZE, 125, Short.MAX_VALUE)
    ...
    private void AddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddActionPerformed
        ...
        if(checkVal()){
            int deptId=Integer.valueOf(DeptId.getText());
