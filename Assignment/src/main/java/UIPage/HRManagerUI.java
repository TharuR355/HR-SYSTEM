 ...
 */
package UIPage;
import UIPage.DepartmentUI;

public class HRManagerUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Adddesig = new javax.swing.JMenuItem();
        ...
        AddDept.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_D, java.awt.event.InputEvent.CTRL_DOWN_MASK));
        AddDept.setText("Add Dept.");
        ...
        jMenu3.setText("Designation");

        Adddesig.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_D, java.awt.event.InputEvent.SHIFT_DOWN_MASK | java.awt.event.InputEvent.CTRL_DOWN_MASK));
        Adddesig.setText("Add Designation");
    ...
    private void AddDeptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddDeptActionPerformed
        ...
        DepartmentUI Info = new DepartmentUI();
    ...
    private void AdddesigActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AdddesigActionPerformed
        // TODO add your handling code here:
        DesignationUI Info = new DesignationUI();
        Info.setVisible(true);
    }//GEN-LAST:event_AdddesigActionPerformed

    private void jMenuItem8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem8ActionPerformed
        // TODO add your handling code here:
        EmployeeUI Info = new EmployeeUI();
        Info.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HRManagerUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HRManagerUI().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JMenuItem Adddesig;
